...
let QuestionComponent = class QuestionComponent {
    constructor(router, userService, questionService, answerService) {
        this.router = router;
        this.userService = userService;
...
let QuizComponent = class QuizComponent {
    constructor(router, userService, route, quizService, questionService) {
        this.router = router;
        this.userService = userService;
        this.route = route;
...
let StudentComponent = class StudentComponent {
    constructor(userService, quizService, router) {
        this.userService = userService;
        this.quizService = quizService;
        this.router = router;
...
let TeacherProfileComponent = class TeacherProfileComponent {
    constructor(userService, quizService, router) {
        this.userService = userService;
        this.quizService = quizService;
        this.router = router;
